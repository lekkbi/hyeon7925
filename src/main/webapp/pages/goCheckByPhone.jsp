...
<div style="text-align:center; font-size: large; padding: 10px"><strong>본인인증</strong></div>
	<form action="" style="padding: 10px; line-height: 30px">
		<dl>
		...
		<dl>
			...
			<dd>
				<div class="form-group v2">
					...
					</select> <input type="text" name="tel2" id="tel2" maxlength="4"
						class="i_text" title="휴대전화번호"> <input type="text"
						name="tel3" id="tel2" maxlength="4" class="i_text" title="휴대전화번호">
				</div>
			</dd>
		</dl>
		<dl>
