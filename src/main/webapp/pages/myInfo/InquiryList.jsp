			...
			<div class="inner-box">
				...
				<article class="mypage-wrap mypage-grade mypage-counsil">
					...
					<div class="info-wrap">
						...
						<div class="text-type">${ member_name }님께서 문의하신 내용은 <strong>총 0건</strong> 입니다.</div>
					</div>
							...
							<table>
								...
								<c:if test="${empty list }">
								 ...
								 <c:if test="${not empty list }">
	                                 ...
	                                 <tr>
	                                 	<td>${ dto.iq_code }</td>
	                                 	<td><a href="qustionView.do?iq_code=${ dto.iq_code }">${ dto.iq_title }</td>
	                                 	<td>${ dto.iq_date }</td>
							...
							<div class="form-item">
								<div class="select-type2">
									<select id="shop_name" name="shop_name">
										<option>매장 선택</option>
										<!--다니엘님한테 매장값받아야됨  -->
										<option value="서울다니엘">서울다니엘</option>
										<option value="인천다니엘">인천다니엘</option>
										<option value="경기다니엘">경기다니엘</option>
										<!-- /다니엘  -->
