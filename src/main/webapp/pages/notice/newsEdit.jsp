q<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
                    ...
                    <article class="notice-area">
                        ...
                        <form id="newsForm" name="newsForm" method="post" > <!--action=""-->
                            ...
                            <dl class="news-content">                            
                                <dt>
                                	<strong>제목<input type="text" placeholder="제목을 입력하세요" autofocus="autofocus" id="title" name="title" value="${ dto.title }"></strong>
                                </dt>
                                <dd>
									<textarea placeholder="공지 본문" id="content" name="content">${ dto.content }</textarea>
                                </dd>
                            </dl>
